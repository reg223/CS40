 ...
 * 
 *     Summary
 *     This file is one of the incompatible implementations used by A2Methods.
 *     Specifically, a2plain connects it to the provided UArray2 interface.
 * 
 *     Notes
 *     For compatibility, new_with_blocksize and blocksize were implemented
 *     where blocksize is hard coded to 1.
 * 
 */
